...
public class TestEtIngilizce extends AppCompatActivity implements View.OnClickListener {
    ...
    LinearLayout lineerReklamBanner12,lineerReklamBanner13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_et_ingilizce);
        ...
        lineerReklamBanner12=findViewById(R.id.lineerReklamBanner12);
        lineerReklamBanner13=findViewById(R.id.lineerReklamBanner13);



        reklamGetir=new ReklamGetir();

        String reklamKodu1=getString(R.string.reklambanner12);
        reklamGetir.BannerReklam(lineerReklamBanner12,getApplicationContext(),reklamKodu1);

        String reklamKodu2=getString(R.string.reklambanner13);
        reklamGetir.BannerReklam(lineerReklamBanner13,getApplicationContext(),reklamKodu2);
        ...
        rastgeleKelime.RastgeleUret(txtCevapA,txtCevapB,txtCevapC,txtCevapD,txtKelime,randomsayi,randomsayiSakla,1);
